...
def compare_runs(baseline: list[dict], candidate: list[dict],
    ...
    The eight metrics are one family, judged together (see _holm); asking
    them at 95% each and reporting whatever cleared found something in
    82.5% of runs where nothing had been changed. The corners are not in
