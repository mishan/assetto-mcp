...
# normalizedCarPosition, and unreachable by a legitimate line crossing --
# that advances completedLaps and is handled before this check runs.
ABANDON_JUMP = 0.25
...
class Collector:
    ...
    def _loop(self, sim, AC_LIVE):
        ...
        while not self._stop.is_set():
            ...
            #
            # Crossing the line also sends norm_pos from ~1.0 to ~0.0, but
            # that is handled above and resets lap_samples, so anything
            # reaching here is a genuine teleport.
