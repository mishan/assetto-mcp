...
try:
    import pytest
    # Without this, pytest imports the module, calls lua_harness.load() and
    # gets an ImportError -- nine errors instead of nine skips on a machine
    # that was never going to have lupa.
    pytestmark = pytest.mark.skipif(SKIP, reason="lupa is not installed")
except ImportError:      # standalone runner, no pytest
    pytest = None
